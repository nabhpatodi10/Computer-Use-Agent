...
class OmniParser:
    ...
    def parse_image(self, image_path: str) -> list:
        ...
        parsed_content_list_filtered = [i for i in parsed_content_list if i["interactivity"]]
        
        return parsed_content_list_filtered